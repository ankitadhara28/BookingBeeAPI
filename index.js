...
function hotelsort(hotel1,hotel2,pricing)
{
  return pricing==='high-to-low'?hotel2.price - hotel1.price : hotel1.price - hotel2.price;
}
...
app.get("/hotels/sort/pricing",(req,res)=>
{
  ...
  hotelscopy.sort(hotelsort);
  res.json(hotelscopy);
})

function hotelsortwrtrating(ratings)
{
...
app.get("/hotels/sort/rating",(req,res)=>
{
  ...
  let hotelscopy = hotels.slice();
  hotelscopy.sort(hotelsortwrtrating(ratings));
  res.json(hotelscopy);
})

function hotelsortwrtreviews(reviews) {
  return (hotel1, hotel2) => {
    return reviews === 'most-to-least'
...
app.get("/hotels/sort/reviews",(req,res)=>
{
  ...
  let hotelscopy = hotels.slice();
  hotelscopy.sort(hotelsortwrtreviews(reviews));
  res.json(hotelscopy);
})
